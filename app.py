...
with right:
    ...
    if prediction_proba[0] > 0.5:
      st.markdown(
        ...
        "<div class='stAlert' style='background-color:#fff3cd; color:#856404; padding: 10px; font-size:16px; border-radius: 6px;'>"
      ...
      st.markdown(
        "<div style='text-align:center;'>"
        "<div class='stAlert' style='background-color:#d1ecf1; color:#0c5460; padding: 10px;font-size:16px; border-radius: 6px;'>"

...
# Layout with two columns: inputs on the left, prediction on the right
...
with output_col:
    ...
    if st.button("Predict"):
        ...
        st.write(f"Probability of Heart Disease: **{prediction_proba[0]*100:.2f}**%")
        ...
        # Link to data insights dashboard
        st.markdown(
            "[**View Data Insights Dashboard**](https://your-dashboard-link.com)",

...
# Apply custom CSS for a simpler theme and scrollable area for inputs
st.markdown("""
    <style>
...
st.markdown("---") # Separator before prediction result

# Prediction Result Section (now in the single column flow)
